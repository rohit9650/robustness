...
#%%
# explanation methods
methods = ['occlusion','shapley_sampling']
...
try:
  ...
  import pickle
with open('/Users/rohitsingh/Desktop/project/robustness1/results/imagenet/metadata/Anchor_misclassification.pkl', 'rb') as input:
    tmp = pickle.load(input)
# %%
print(tmp['anchor']['p'])
print(tmp['anchor_comp']['p'])



# %%
from robustness import Robustness
robustness = Robustness([tmp])


# %%
robustness.MakeReport('tmp.txt')
